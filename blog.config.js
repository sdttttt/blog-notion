...
const BLOG = {
	...
	CONTACT_EMAIL: 'sdttttt@icloud.com',
	CONTACT_WEIBO: '',
	CONTACT_TWITTER: '',
	...
	COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'sdttttt/sdttttt.github.io', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
	COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIWzItw', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
	COMMENT_GISCUS_CATEGORY_ID:
		process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIWzIt84CShml', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
	...
	TITLE: process.env.NEXT_PUBLIC_TITLE || 'sdttttt', // 站点标题 ，被notion中的页面标题覆盖
	DESCRIPTION:
		process.env.NEXT_PUBLIC_DESCRIPTION || 'sdtttt blog power by NotionNext', // 站点描述，被notion中的页面描述覆盖
